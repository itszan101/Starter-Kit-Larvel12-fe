            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-lg-0">
                    <li class="nav-item dropdown me-1">
                        <a class="nav-link active dropdown-toggle text-pr" href="#" data-bs-toggle="dropdown"
                            aria-expanded="false">
                    ...
                    <li class="nav-item me-1 d-flex align-items-center">
                        <button id="toggle-dark"
                            class="btn btn-light d-flex align-items-center justify-content-center rounded"
                            style="width:35px; height:35px; line-height:1rem">
                ...
                <div class="dropdown">
                    <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="user-menu d-flex">
                            <div class="user-name text-end me-3">
                                <h6 class="mb-0 text-pr">{{ $user['name'] ?? 'Guest' }}</h6>
                                <p class="mb-0 text-sm text-pr">{{ $user['role'] ?? 'User' }}</p>
                            </div>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" style="min-width: 11rem; color: #FAFAFA;">
                        <li>
